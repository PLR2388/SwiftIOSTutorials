...
let rendered = renderer.image { ctx in
    ...
    ctx.cgContext.fill(CGRect(x: 600, y: 0, width: 400, height: 400))
    ctx.cgContext.fill(CGRect(x: 600, y: 600, width: 400, height: 400))
    ctx.cgContext.fill(CGRect(x: 0, y: 600, width: 400, height: 400))
}
