...
//  Project 8
//
//  Created by Paul-Louis Renard on 22/09/2021.
//
...
class ViewController: UIViewController {
    ...
    override func loadView() {
        ...
        for row in 0..<4 {
            for col in 0..<5 {
                ...
                // give the buttom some temporary text so we can see it on-screen
    ...
    @objc func submitTapped(_ sender: UIButton) {
        ...
        if let solutionPosition = solutions.firstIndex(of: answerText) {
            ...
            let remained = splitAnswers?.filter{ value in
            ...
            score -= 1
            let ac = UIAlertController(title: "Wrong", message: "Your answer was wrong", preferredStyle: .alert)
